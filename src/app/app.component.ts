...
export class ConferenceApp {
  ...
  appPages: PageInterface[] = [
    ...
    { title: 'Aluguéis', name: 'TabsPage', component: TabsPage, tabComponent: SpeakerListPage, index: 1, icon: 'card' },
    { title: 'Consultórios', name: 'TabsPage', component: TabsPage, tabComponent: MapPage, index: 2, icon: 'pulse' },
  ...
  loggedInPages: PageInterface[] = [
    ...
    { title: 'Inscrever-se', name: 'TabsPage', component: TabsPage, icon: 'log-out', logsOut: true }
  ];
